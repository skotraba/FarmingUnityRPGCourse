...
public class ObscurringItemFader : MonoBehaviour
{
    ...
    // Coroutine split execution over a number of frames and to show that they finish processing, you can use yeild return statements
